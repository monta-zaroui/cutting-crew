<template>
  <Menu as="div" class="relative inline-block text-left">
    <div>
      <MenuButton class="inline-flex w-full justify-center rounded-md border border-orange-400 bg-white px-4 py-2 text-sm font-bold text-orange-400 shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-1 focus:ring-orange-400 focus:ring-offset-orange-400">
        Köln-Marsdorf
